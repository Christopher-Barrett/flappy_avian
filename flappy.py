...
def create_pipe():
    ...
    top_pipe = pipe_surface.get_rect(midbottom = (700, random_pipe_position - 400))
...
game_font = pygame.font.SysFont('papyrus',40)
...
bird_down = bird_surface = pygame.transform.scale2x(pygame.image.load('flappy-bird-assets/sprites/bluebird-downflap.png').convert_alpha())
bird_mid = bird_surface = pygame.transform.scale2x(pygame.image.load('flappy-bird-assets/sprites/bluebird-midflap.png').convert_alpha())
bird_up =bird_surface = pygame.transform.scale2x(pygame.image.load('flappy-bird-assets/sprites/bluebird-upflap.png').convert_alpha())
